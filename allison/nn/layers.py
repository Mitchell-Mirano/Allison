...
class LayerDense:
    ...
    def __init__(self,n_features:int,n_neurones:int,activation_function:str):
        ...
        elif self.activation_function.__name__ in ['relu','linear']:
    ...
    def backward(self,Delta_l,Activation_l_1,Weights_l):

        Delta_l = Delta_l@Weights_l.T*self.activation_function(self.z,True)

        self.DL=Activation_l_1.T@Delta_l
        self.Db=Delta_l.sum(axis=0)
    ...
    def backward_first_layer(self,Delta_l,Activation_l_1,Weights_l):
